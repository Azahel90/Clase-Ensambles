...
if nargout ==3
   numOfConsecutiveBins = getArgumentValue('numOfConsBins',3,varargin{:});
   ...
   latency = str2num(significantlyAwayFromPointFive);%%min(strfind(significantlyAwayFromPointFive,s'));
end
